...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.HotelViewHolder> {
    ...
    int images[];
    Context context;
    public HotelAdapter(Context ct, String s1[], String s2[], String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    @NonNull
    @Override
    public HotelAdapter.HotelViewHolder
    ...
    public void onBindViewHolder(@NonNull
                                             HotelAdapter.HotelViewHolder holder, int position) {
